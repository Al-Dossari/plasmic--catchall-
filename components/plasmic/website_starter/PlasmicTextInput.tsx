...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: TO_adoaTCD1F/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__hnYM)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__buNqc)}
              role={"img"}
            />
          ),
